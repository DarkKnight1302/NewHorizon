...
namespace NewHorizon.Services.ColleagueCastleServices
{
    public class InterestService : IInterestService
    {
        ...
        public InterestService(IPropertyPostService propertyPostService, IMailingService mailingService, IUserRepository userRepository, IUserInterestRepository userInterestRepository)
        {
